...
public final class VATCertificate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String userId = (String) session.getAttribute("userId");
 ...
 currentIndividual=(Integer)session.getAttribute("individualTicket");
      ...
      out.write("        ");
            ...
            Font font3 = new Font(Font.FontFamily.HELVETICA, 15, Font.BOLD | Font.NORMAL);
           ...
           //image.scaleAbsolute(400, 50);
            ...
            Paragraph par = new Paragraph(new Chunk( " Notice of Registration on ", font2));
           ...
           Paragraph par1 = new Paragraph(new Chunk( "( Under the Law... Section ... )", font3));
            ...
            document.add(par5);
            document.add(new Paragraph("\n"));
            Paragraph par6 = new Paragraph(new Chunk( " TaxPayers' Identification Number:  "+in.getTinNumber(), font3));
            ...
            document.add(par8);
            document.add(new Paragraph("\n")); 
            Paragraph par9 = new Paragraph(new Chunk( " Doc Number:1  ", font3));

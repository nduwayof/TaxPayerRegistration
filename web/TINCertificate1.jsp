...
<html>
    ...
    <body>
        ...
        for(NonIndividual n: NonIndividual.listNonIndividual()){
            if(n.getTinNumber().equalsIgnoreCase(tinNumber)){
                nonIndvidualId=n.getNonIndividualId();
            }
        }
        
            response.setContentType("application/pdf");
            //Individual.getDocument(indvidualId, response.getOutputStream());
            NonIndividual.getDocument(nonIndvidualId, response.getOutputStream());
        %>
    </body>
</html>

...
<html>
    ...
    <body>
        <%     
        int nonIndvidualId=0;
        String tinNumber=request.getParameter("tinNumber");
        for(NonIndividual i: NonIndividual.listNonIndividual()){
        if(i.getTinNumber().equalsIgnoreCase(tinNumber)){
        nonIndvidualId=i.getNonIndividualId();
        }
        }
      ...
      String vatDocumentNumber="";
            try {
                for (NonIndividual in : NonIndividual.listNonIndividual()) {
                    if (in.getNonIndividualId() == (nonIndvidualId)) {
                        tin=in.getTinNumber();
           ...
           Image image = Image.getInstance("/Users//SULAIMAN//NetBeansProjects//TaxPayerRegistration//build//web\\"+in.getPhoto());
            ...
            //document.add(new Paragraph("\n")); 
                        ...
                        Paragraph par2 = new Paragraph(new Chunk("  Enteprise Type:  " + in.getEnterpriseType(), font3));
                ...
                Paragraph par3 = new Paragraph(new Chunk(" Business Activity:  ", font3));
                        ...
                        for(NonIndividual_mainSectorActivity i: NonIndividual_mainSectorActivity.list()){
                            if(i.getNonIndividualId()==nonIndvidualId){
                        ...
                        for(NonIndividual_Address a: NonIndividual_Address.list()){
                            if(a.getNonIndividualId()==nonIndvidualId){

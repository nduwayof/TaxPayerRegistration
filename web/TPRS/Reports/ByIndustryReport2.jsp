...
<%@page import="com.djuma.NonIndividual_mainSectorActivity"%>
              ...
              //  String itnm = request.getParameter("username");
                ...
                for(Industry t: Industry.listIndistry()){
                  ...
                  for(Sector s: Sector.listSector()){
                      ...
                      for(NonIndividual_mainSectorActivity im: NonIndividual_mainSectorActivity.list()){
              ...
              //  String itnm = request.getParameter("username");
                ...
                for(Industry t: Industry.listIndistry()){
                   if(t.getId()==Integer.parseInt(value)){ 
                    for(Sector s: Sector.listSector()){
                    if(s.getIndustryId()==t.getId()){
                    for(NonIndividual_mainSectorActivity m: NonIndividual_mainSectorActivity.list()){
                        if(m.getSectorId()==s.getId()){
                for(NonIndividual in:NonIndividual.listNonIndividual()) {
                   if(in.getNonIndividualId()==m.getNonIndividualId()&&in.isHasInfo()&&in.isDeregistered()==false){

...
<html>
    ...
    <body>
        <%
            String value=request.getParameter("enterpriseType");
          ...
          //  String itn = request.getParameter("itnm");
           ...
           //image.scaleAbsolute(400, 50);
            ...
            Paragraph par = new Paragraph(new Chunk( " "+   "Report of business of "+value+" " + da , font2));
            ...
            try {
              //  String itnm = request.getParameter("username");
                ...
                for(NonIndividual in: NonIndividual.listNonIndividual()) {
                   if(in.isHasInfo()&&in.isDeregistered()==false && in.getEnterpriseType().equalsIgnoreCase(value)){

...
<html>
    ...
    <body>
        <%
            String value=request.getParameter("sizeOfTax");
            String type="";
           ...
           //image.scaleAbsolute(400, 50);
            ...
            try {
              //  String itnm = request.getParameter("username");
                ...
                for(TaxPayerType t: TaxPayerType.listTaxPayerType()){
                   if(t.getId()==Integer.parseInt(value)){ 
                    for(Nonindividual_TaxPayerType it: Nonindividual_TaxPayerType.list()){
                    if(it.getTaxPayerTypeId()==t.getId()){
                for(NonIndividual in: NonIndividual.listNonIndividual()) {
                   if(in.getNonIndividualId()==it.getNonIndividualId()&&in.isHasInfo()&&in.isDeregistered()==false){

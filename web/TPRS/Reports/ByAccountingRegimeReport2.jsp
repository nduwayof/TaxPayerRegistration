...
<html>
    ...
    <body>
        <%
            String value=request.getParameter("accountingregime");
          ...
          //  String itn = request.getParameter("itnm");
           ...
           //image.scaleAbsolute(400, 50);
            ...
            Paragraph par = new Paragraph(new Chunk( " "+   "Report of "+value+" as Source of Income " + da , font2));
           ...
           PdfPTable tablee1 = new PdfPTable(1);
            tablee1.addCell(new Phrase(new Chunk(" Entreprise Type ", FontFactory.getFont(FontFactory.TIMES_BOLD, 13, Font.BOLD, BaseColor.MAGENTA))));
            ...
            try {
              //  String itnm = request.getParameter("username");
                ...
                for(NonIndividual_Activity t: NonIndividual_Activity.list()){
                   if(t.getAccountingMethod().equalsIgnoreCase(value)){ 
                for(NonIndividual in: NonIndividual.listNonIndividual()) {
                   if(in.getNonIndividualId()==t.getNonIndividualId()&&in.isHasInfo()&&in.isDeregistered()==false){

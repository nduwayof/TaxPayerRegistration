...
<html>
    ...
    <body>
        <%
            String value=request.getParameter("proivnce");
          ...
          //  String itn = request.getParameter("itnm");
           ...
           //image.scaleAbsolute(400, 50);
            ...
            Paragraph par = new Paragraph(new Chunk( " "+   "Report of business from"+value+" " + da , font2));
              ...
              //  String itnm = request.getParameter("username");
                ...
                for(NonIndividual in: NonIndividual.listNonIndividual()) {
                   if(in.isHasInfo()&&in.isDeregistered()==false){
                       for(NonIndividual_Address is: NonIndividual_Address.list()){
                           if(is.getNonIndividualId()==in.getNonIndividualId()){

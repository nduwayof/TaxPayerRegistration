...
public class NonIndividual_Bank {
    ...
    public static List<NonIndividual_Bank>listBank(){
     List<NonIndividual_Bank>list=new ArrayList<NonIndividual_Bank>();
     try{
     PreparedStatement djuma=SetCon.getCon().prepareStatement("select * from nonIndividual_bank");
         ResultSet rs=djuma.executeQuery();
         while(rs.next()){
         NonIndividual_Bank b=new NonIndividual_Bank();
     ...
     public static List<NonIndividual_Bank>listBankPerNonIndividual(int indId){
     List<NonIndividual_Bank>list=new ArrayList<NonIndividual_Bank>();
     try{

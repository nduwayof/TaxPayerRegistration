...
public class NonIndividual_Branches {
    ...
    public static List<NonIndividual_Branches>listBranch(){
    List<NonIndividual_Branches>list=new ArrayList<NonIndividual_Branches>();
    try{
    ...
    PreparedStatement djuma=SetCon.getCon().prepareStatement("select * from nonIndividual_branches");
        ...
        while(rs.next()){
        NonIndividual_Branches b=new NonIndividual_Branches();
    ...
    return list;
       ...
       public static List<NonIndividual_Branches>listBranchPerNonIndividual(int indId){
    List<NonIndividual_Branches>list=new ArrayList<NonIndividual_Branches>();
    try{
